var IosDeviceProductNameMapper = (function () {
    function IosDeviceProductNameMapper() {
        this.map = {
            "iPhone1,1": "iPhone",
            "iPhone1,2": "iPhone 3G",
    ...
    IosDeviceProductNameMapper.prototype.resolveProductName = function (deviceType) {
        return this.map[deviceType];
    };
    return IosDeviceProductNameMapper;
}());
