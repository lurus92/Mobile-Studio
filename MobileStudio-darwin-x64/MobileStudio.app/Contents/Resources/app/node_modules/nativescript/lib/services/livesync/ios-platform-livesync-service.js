...
var IOSPlatformLiveSyncService = (function (_super) {
    __extends(IOSPlatformLiveSyncService, _super);
    function IOSPlatformLiveSyncService(_liveSyncData, $devicesService, $mobileHelper, $logger, $options, $deviceAppDataFactory, $fs, $injector, $projectFilesManager, $projectFilesProvider, $platformService, $liveSyncProvider) {
    ...
    IOSPlatformLiveSyncService.prototype.fullSync = function (postAction) {
        var _this = this;
        return (function () {
    ...
    return IOSPlatformLiveSyncService;
