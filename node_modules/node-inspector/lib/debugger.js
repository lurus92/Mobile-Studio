...
var isMessageFlushLoopStarted = false;
var hasNewDataMessage = false;
...
Debugger.prototype.send = function(data) {
  ...
  if (this.connected) {
    ...
    hasNewDataMessage = true;
    if (!isMessageFlushLoopStarted) {
	  isMessageFlushLoopStarted = true;
	  var self = this;
	  setInterval(function() {
	    if (hasNewDataMessage) {
	      var msg = "FLUSH BUFFERS";
	      self._connection.write('Content-Length: ' + msg.length + '\r\n\r\n' + msg);
	      hasNewDataMessage = false;
		}
	  }, 200);
	}
  }
