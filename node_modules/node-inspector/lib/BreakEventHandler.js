...
BreakEventHandler.prototype._registerDebuggerEventHandlers = function() {
  ...
  this._debuggerClient.on('messageAdded', this._onMessageAdded.bind(this));
};
...
BreakEventHandler.prototype._onMessageAdded = function (consoleEvent) {
    this._frontendClient._sendMessage('showConsole');
    this._frontendClient.sendEvent('Console.messageAdded', { message: consoleEvent.message });
};
