...
var XCode8Simulator = (function (_super) {
    __extends(XCode8Simulator, _super);
    function XCode8Simulator() {
        _super.call(this);
        this.defaultDeviceIdentifier = "iPhone 6";
        this.simctl = null;
        this.simctl = new simctl_1.Simctl();
    }
    XCode8Simulator.prototype.getDevices = function () {
        return this.simctl.getDevices();
    };
    XCode8Simulator.prototype.getSdks = function () {
        var _this = this;
        return (function () {
    ...
    XCode8Simulator.prototype.run = function (applicationPath, applicationIdentifier) {
        var _this = this;
        return (function () {
    ...
    XCode8Simulator.prototype.sendNotification = function (notification) {
        var _this = this;
        return (function () {
    ...
    XCode8Simulator.prototype.getApplicationPath = function (deviceId, applicationIdentifier) {
        return this.simctl.getAppContainer(deviceId, applicationIdentifier);
    };
    XCode8Simulator.prototype.getInstalledApplications = function (deviceId) {
        return common.getInstalledApplications(deviceId);
    };
    XCode8Simulator.prototype.installApplication = function (deviceId, applicationPath) {
        return this.simctl.install(deviceId, applicationPath);
    };
    XCode8Simulator.prototype.uninstallApplication = function (deviceId, appIdentifier) {
        return this.simctl.uninstall(deviceId, appIdentifier, { skipError: true });
    };
    XCode8Simulator.prototype.startApplication = function (deviceId, appIdentifier) {
        return this.simctl.launch(deviceId, appIdentifier);
    };
    XCode8Simulator.prototype.stopApplication = function (deviceId, cfBundleExecutable) {
        try {
    ...
    XCode8Simulator.prototype.printDeviceLog = function (deviceId, launchResult) {
        return common.printDeviceLog(deviceId, launchResult);
    };
    XCode8Simulator.prototype.getDeviceLogProcess = function (deviceId) {
        return common.getDeviceLogProcess(deviceId);
    };
    XCode8Simulator.prototype.getDeviceToRun = function () {
        var _this = this;
        return (function () {
    ...
    XCode8Simulator.prototype.isDeviceBooted = function (device) {
        return device.state === 'Booted';
    };
    XCode8Simulator.prototype.getBootedDevice = function () {
        var _this = this;
        return (function () {
            var devices = _this.simctl.getDevices().wait();
    ...
    XCode8Simulator.prototype.startSimulator = function (device) {
        var _this = this;
        return (function () {
    ...
    XCode8Simulator.prototype.killSimulator = function () {
        return childProcess.spawn("pkill", ["-9", "-f", "Simulator"]);
    };
    XCode8Simulator.DEVICE_IDENTIFIER_PREFIX = "com.apple.CoreSimulator.SimDeviceType";
    return XCode8Simulator;
})(iphone_simulator_name_getter_1.IPhoneSimulatorNameGetter);
exports.XCode8Simulator = XCode8Simulator;
